/*! jquery.spriteAnimation - v0.2.3 - 2013-10-12
		...
		return this.each(function() {
			...
			if(settings && typeof settings === "object") {
				...
				if (settings.gotoAndPlay){
					...
					if(anim.options.sequences[settings.setSequence].reverse === true){
						settings.gotoFrame = anim.options.sequences[settings.setSequence].length-1;
						settings.command = 'rewind';
					} else {
						settings.command = 'play';
					}
				}
